...
lib LibSerialPort
  ...
  fun blocking_read = "sp_blocking_read"(port : Port*, buf : Void*, count : UInt32, timeout_ms : UInt16) : Return
  fun blocking_read_next = "sp_blocking_read_next"(port : Port*, buf : Void*, count : UInt32, timeout_ms : UInt16) : Return
  fun nonblocking_read = "sp_nonblocking_read"(port : Port*, buf : Void*, count : UInt32) : Return
  fun blocking_write = "sp_blocking_write"(port : Port*, buf : Void*, count : UInt32, timeout_ms : UInt16) : Return
  fun nonblocking_write = "sp_nonblocking_write"(port : Port*, buf : Void*, count : UInt32) : Return
